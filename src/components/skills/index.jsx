...
const typescript ={
    id: 'TypeScript',
    icon: <TypeScript className="typescript"> <img src={TypeScriptIcon} alt="" /> </TypeScript>
}
const react = {
    id: 'React',
...
const styled = {
    ...
    icon: <Styled className="styled"> <img src={StyledIcon} alt="" /> </Styled>
}
const sass ={
    id: 'Sass',
    icon: <Sass className="sass"> <img src={SassIcon} alt="" /> </Sass>
}
const jest ={
    id: 'Jest',
    icon: <Jest className="jest"> <img src={JestIcon} alt="" /> </Jest>
}
